...
const destinos = [
  { id: 1, nombre: 'Paris, Francia',     continente: 'Europa',  precio: 1200000, img: '/paris.jpg',     duracion: '7 dias',  descripcion: 'Disfruta de la ciudad luz con visitas a la Torre Eiffel, el Louvre y un crucero por el Sena.', incluye: ['Vuelo ida y vuelta', 'Hotel 5 estrellas', 'Desayuno buffet', 'Tour guiado'], rating: 4.8, video: '_iZ-vMCeH9U' },
  { id: 2, nombre: 'Cusco, Peru',        continente: 'America', precio: 450000,  img: '/peru.jpg',      duracion: '5 dias',  descripcion: 'Explora Machu Picchu, el Valle Sagrado y la ciudad imperial de los Incas.',             incluye: ['Vuelo ida y vuelta', 'Hotel 4 estrellas', 'Desayuno', 'Tour a Machu Picchu'], rating: 4.7, video: 'PJBUryd9GDI' },
  { id: 3, nombre: 'Tokio, Japon',       continente: 'Asia',    precio: 1800000, img: '/japon.jpg',     duracion: '10 dias', descripcion: 'Sumergete en la cultura japonesa con visitas a Shibuya, el Templo Sensoji y Monte Fuji.',  incluye: ['Vuelo ida y vuelta', 'Hotel 4 estrellas', 'Media pension', 'Japan Rail Pass'], rating: 4.9, video: 'Ownf2_TGj1M' },
  { id: 4, nombre: 'Cartagena, Colombia', continente: 'America', precio: 600000,  img: '/colombia.avif', duracion: '4 dias',  descripcion: 'Playas caribeñas, ciudad amurallada y la mejor gastronomia del Caribe colombiano.',      incluye: ['Vuelo ida y vuelta', 'Hotel 5 estrellas', 'Desayuno', 'Tour en chiva'], rating: 4.6, video: 'T97KnUvod8w' },
  { id: 5, nombre: 'Roma, Italia',       continente: 'Europa',  precio: 1500000, img: '/italia.webp',   duracion: '8 dias',  descripcion: 'El Coliseo, el Vaticano y la Fontana di Trevi te esperan en la ciudad eterna.',          incluye: ['Vuelo ida y vuelta', 'Hotel 4 estrellas', 'Desayuno', 'Entradas a museos'], rating: 4.8, video: '1-bLGdChz3Q' },
  { id: 6, nombre: 'Bangkok, Tailandia',  continente: 'Asia',    precio: 950000,  img: '/bangkok.jpg',   duracion: '7 dias',  descripcion: 'Templos dorados, mercados flotantes y la mejor comida callejera del sudeste asiatico.',   incluye: ['Vuelo ida y vuelta', 'Hotel 5 estrellas', 'Desayuno', 'Tour en barco'], rating: 4.7, video: 'TyJVYbhDH5U' },
]
